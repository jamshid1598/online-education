...
class NewUserForm(UserCreationForm):
	email = forms.EmailField(
		required=True,
		label="Email Addres",
		widget=forms.EmailInput(attrs={"type":"email", "class":"form__input", "id":"email", "name":"email", "placeholder":_("email"),}), #class="form__input" id="email" name="email" type="email" placeholder="Elektron pochta"
	)

	first_name = forms.CharField(
		required=True,
		label="First Name",
		widget=forms.TextInput(attrs={"type":"text", "class":"form__input", "id":"f_name", "name":"f_name", "placeholder":_("first name"),}), #class="form__input" id="Name" name="Name" type="text" placeholder="IFSH"
	)

	second_name = forms.CharField(
		required=True,
		label="Имя пользователя",
		widget=forms.TextInput(attrs={"type":"text", "class":"form__input", "id":"s_name", "name":"s_name", "placeholder":_("second name"),}), #class="form__input" id="Name" name="Name" type="text" placeholder="IFSH"
	)
	...
	# 	# label=_("Telefon raqam"),
	# 	widget=forms.TextInput(
	# 		attrs={'class':"form__input", 'id':"text", 'name':"text", 'type':"text", "placeholder":_("phone number"),}
	# 	)
	# )
